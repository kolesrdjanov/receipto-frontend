...
export function CategorySuggestionCard({
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-purple-50/80 dark:bg-purple-950/20 border border-purple-200/60 dark:border-purple-800/40">
      <div className="flex items-center gap-2.5 flex-1 min-w-0">
        <Sparkles className="h-3.5 w-3.5 text-purple-500 dark:text-purple-400 shrink-0" />
